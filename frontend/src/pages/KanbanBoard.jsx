...
const Column = ({ title, tasks, count, onAdd }) => (
    <div className="bg-slate-50/50 rounded-2xl p-4 flex flex-col gap-4 min-w-[320px]">
        ...
        <button className="flex items-center justify-center gap-2 py-3 text-slate-500 hover:text-blue-600 font-medium text-sm transition-colors mt-2">
        ...
        <div className="flex min-h-screen bg-white">
            ...
            <main className="flex-1 lg:ml-64 p-8">
                ...
                <div className="flex gap-6 overflow-x-auto pb-4">
                    ...
                    <Column title="Done" tasks={doneTasks} count={doneTasks.length} />
                </div>
            </main>
        </div>
    );
